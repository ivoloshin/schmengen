    ...
    getCalendarDays, getWeekStarts, getMonths,
        ...
        const TRANSLATIONS = {
            ...
            es: {
                ...
                addBtn: "Añadir Viaje", calendarHeader: "Calendario", delete: "Borrar",
                overlap: "Fecha ocupada.", overlapRange: "¡Superposición! Fechas ocupadas.", prompt: "Selecciona Fin",
                prev: "Ant", next: "Sig", today: "Hoy",
                laneTrips: "Viajes", laneAnalysis: "Análisis Seguro (Verde = Inicio 90d)",
                limitLabel: "90 DÍAS (LÍMITE)", graphToday: "HOY",
                helpTitle: "Ayuda", tabGuide: "Uso", tabRules: "Reglas",
                interactionTitle: "Interacción Básica", legendTitle: "Leyenda",
                h_tapEmpty: "Doble toque (vacío)", h_tapEmptyDesc: "Crear un nuevo viaje.",
                ...
                h_dragEdge: "Arrastrar borde", h_dragEdgeDesc: "Extender o acortar la duración.",
                h_dragTime: "Tocar/Arrastrar línea", h_dragTimeDesc: "Usar herramienta de análisis para simular uso.",
                safeTrip: "Viaje Seguro", overstayRisk: "Riesgo (>90 días)", safeZone: "Zona Segura (Inicio 90d)",
                ruleTitle: "La Regla 90/180", ruleText1: "Puedes permanecer máximo 90 días en cualquier periodo de 180 días.",
                rollingTitle: "Ventana Móvil", rollingText: "Las autoridades miran los 179 días anteriores + hoy.",
                appHelps: "Cómo ayuda la app:", appHelp1: "Calcula la ventana móvil para cada día.",
                appHelp2: "La herramienta de análisis muestra días usados en la ventana de 180 días.",
                appHelp3: "La línea verde muestra dónde puedes iniciar un viaje de 90 días.",
                disclaimerTitle: "Aviso Legal", disclaimerText: "Solo para estimación. Verifique con fuentes oficiales.",
                linkText: "Calculadora Oficial UE",
                usedPrior: "Usado (180d prev)", safeStay: "Estancia Segura", sinceLast: "Desde último", untilNext: "Hasta sig.",
                expireMsg: "días expiran durante estancia"
            },
            fr: {
                code: 'fr-FR', label: 'Français', flag: '🇫🇷',
                subtitle: "Calculateur Zone Schengen",
                todayCount: "Compte Actuel", statusSafe: "Tout est bon. Conforme.", statusDanger: "Attention! Dépassement le",
                addBtn: "Ajouter", calendarHeader: "Calendrier", delete: "Supprimer",
                overlap: "Date déjà réservée.", overlapRange: "Chevauchement!", prompt: "Fin du voyage",
                prev: "Préc", next: "Suiv", today: "Auj",
                laneTrips: "Voyages", laneAnalysis: "Analyse (Vert = Départ 90j)",
                limitLabel: "90 JOURS (LIMITE)", graphToday: "AUJ",
                helpTitle: "Aide", tabGuide: "Mode d'emploi", tabRules: "Règles",
                interactionTitle: "Interactions", legendTitle: "Légende",
                h_tapEmpty: "Double tap (vide)", h_tapEmptyDesc: "Créer un nouveau voyage.",
                h_tapTrip: "Double tap (voyage)", h_tapTripDesc: "Supprimer le voyage.",
                h_dragBody: "Glisser le corps", h_dragBodyDesc: "Déplacer le voyage entier.",
                h_dragEdge: "Glisser le bord", h_dragEdgeDesc: "Modifier la durée.",
                h_dragTime: "Tap/Glisser chrono", h_dragTimeDesc: "Outil d'analyse pour simuler l'utilisation.",
                safeTrip: "Voyage Sûr", overstayRisk: "Risque (>90 jours)", safeZone: "Zone Sûre (Départ 90j)",
                ruleTitle: "Règle 90/180", ruleText1: "Maximum 90 jours sur toute période de 180 jours.",
                rollingTitle: "Fenêtre Glissante", rollingText: "On regarde les 179 jours précédents + aujourd'hui.",
                appHelps: "L'appli aide:", appHelp1: "Calcule la fenêtre pour chaque jour.",
                appHelp2: "L'outil d'analyse montre les jours utilisés.",
                appHelp3: "La ligne verte indique où commencer un voyage de 90 jours.",
                disclaimerTitle: "Avis de non-responsabilité", disclaimerText: "Estimation seulement. Vérifiez sources officielles.",
                linkText: "Calculateur Officiel UE",
                usedPrior: "Utilisé (180j préc)", safeStay: "Durée Sûre", sinceLast: "Depuis dernier", untilNext: "Jusqu'au proch.",
                expireMsg: "jours expirent pendant"
            },
            de: {
                code: 'de-DE', label: 'Deutsch', flag: '🇩🇪',
                subtitle: "Schengen-Raum Rechner",
                todayCount: "Aktueller Stand", statusSafe: "Alles gut. Regelkonform.", statusDanger: "Warnung! Überzug am",
                addBtn: "Reise +", calendarHeader: "Kalender", delete: "Löschen",
                overlap: "Datum belegt.", overlapRange: "Überschneidung!", prompt: "Enddatum wählen",
                prev: "Zurück", next: "Weiter", today: "Heute",
                laneTrips: "Reisen", laneAnalysis: "Analyse (Grün = 90T Start)",
                ...
                h_tapTrip: "Doppeltipp (Reise)", h_tapTripDesc: "Reise löschen.",
                h_dragBody: "Reise ziehen", h_dragBodyDesc: "Datum der Reise verschieben.",
                h_dragEdge: "Rand ziehen", h_dragEdgeDesc: "Reisedauer ändern.",
                h_dragTime: "Zeitachse ziehen", h_dragTimeDesc: "Analyse-Tool nutzen.",
                safeTrip: "Sicher", overstayRisk: "Risiko (>90 Tage)", safeZone: "Sicherer Start (90T möglich)",
                ruleTitle: "90/180 Regel", ruleText1: "Maximal 90 Tage Aufenthalt in jedem 180-Tage-Zeitraum.",
                rollingTitle: "Rollierendes Fenster", rollingText: "Gezählt werden die letzten 179 Tage + heute.",
                appHelps: "Funktionen:", appHelp1: "Berechnet das Fenster für jeden Tag.",
                appHelp2: "Zeigt genutzte Tage im 180-Tage-Fenster.",
                appHelp3: "Grüne Linie zeigt sicheren Start für 90-Tage-Reise.",
                disclaimerTitle: "Haftungsausschluss", disclaimerText: "Nur Schätzung. Offiziell prüfen.",
                linkText: "Offizieller EU Rechner",
                usedPrior: "Benutzt (180T)", safeStay: "Möglich", sinceLast: "Seit letztem", untilNext: "Bis nächstem",
                expireMsg: "Tage verfallen während"
            },
            yi: { 
                code: 'en-GB', label: 'Yiddish', flag: '🥯',
                subtitle: "Schengen Zone Calculator",
            ...
            ru: {
                ...
                subtitle: "Калькулятор Шенгена",
                todayCount: "Счетчик дней", statusSafe: "Все в порядке. Нарушений нет.", statusDanger: "Внимание! Просрочка",
                addBtn: "Добавить", calendarHeader: "Календарь", delete: "Удалить",
                overlap: "Дата занята.", overlapRange: "Накладка дат!", prompt: "Дата окончания",
                prev: "Пред", next: "След", today: "Сегодня",
                laneTrips: "Поездки", laneAnalysis: "Анализ (Зеленый = Старт 90д)",
                limitLabel: "90 ДНЕЙ (ЛИМИТ)", graphToday: "СЕГОДНЯ",
                helpTitle: "Помощь", tabGuide: "Инструкция", tabRules: "Правила",
                interactionTitle: "Основы", legendTitle: "Легенда",
                h_tapEmpty: "Двойной тап (пусто)", h_tapEmptyDesc: "Создать новую поездку.",
                h_tapTrip: "Двойной тап (поездка)", h_tapTripDesc: "Удалить поездку.",
                h_dragBody: "Тянуть поездку", h_dragBodyDesc: "Переместить даты поездки.",
                h_dragEdge: "Тянуть край", h_dragEdgeDesc: "Изменить длительность.",
                h_dragTime: "Тянуть шкалу", h_dragTimeDesc: "Инструмент проверки статуса.",
                safeTrip: "Безопасно", overstayRisk: "Риск (>90 дней)", safeZone: "Безопасный старт",
                ruleTitle: "Правило 90/180", ruleText1: "Максимум 90 дней пребывания за любой 180-дневный период.",
                rollingTitle: "Скользящее окно", rollingText: "Учитываются предыдущие 179 дней + сегодня.",
                appHelps: "Как это работает:", appHelp1: "Расчет окна для каждого дня.",
                appHelp2: "Инструмент проверки показывает дни в окне 180 дней.",
                appHelp3: "Зеленая линия показывает, где можно начать поездку на 90 дней.",
                disclaimerTitle: "Отказ от ответственности", disclaimerText: "Только для оценки. Проверяйте официально.",
                linkText: "Официальный калькулятор ЕС",
                usedPrior: "Использовано", safeStay: "Можно дней", sinceLast: "С прошлой", untilNext: "До следующей",
                expireMsg: "дней сгорают"
            },
            zh: {
                code: 'zh-CN', label: '中文', flag: '🇨🇳',
                subtitle: "申根区计算器",
                todayCount: "今日统计", statusSafe: "一切正常。符合规定。", statusDanger: "警告！超期于",
                addBtn: "添加行程", calendarHeader: "日历", delete: "删除",
                overlap: "日期已占用", overlapRange: "日期重叠！", prompt: "选择结束日期",
                prev: "上页", next: "下页", today: "今天",
                laneTrips: "行程", laneAnalysis: "安全分析 (绿色 = 90天起点)",
                limitLabel: "90天 (上限)", graphToday: "今天",
                helpTitle: "帮助", tabGuide: "使用说明", tabRules: "申根规则",
                interactionTitle: "基本操作", legendTitle: "图例",
                h_tapEmpty: "双击（空白处）", h_tapEmptyDesc: "创建新行程。",
                h_tapTrip: "双击（行程）", h_tapTripDesc: "删除现有行程。",
                h_dragBody: "拖动行程", h_dragBodyDesc: "整体移动行程日期。",
                h_dragEdge: "拖动边缘", h_dragEdgeDesc: "调整行程时长。",
                h_dragTime: "拖动时间轴", h_dragTimeDesc: "使用检查工具模拟计算。",
                safeTrip: "安全行程", overstayRisk: "超期风险 (>90天)", safeZone: "安全出发区 (可停留90天)",
                ruleTitle: "90/180 规则", ruleText1: "在任何180天内最多停留90天。",
                rollingTitle: "滚动窗口", rollingText: "当局会查看过去179天加上今天的情况。",
                appHelps: "应用功能：", appHelp1: "计算每一天的滚动窗口。",
                appHelp2: "检查工具显示特定日期180天窗口内的已用天数。",
                appHelp3: "安全分析通道显示可以合法开始90天行程的时间段。",
                disclaimerTitle: "免责声明", disclaimerText: "仅供估算。请以官方为准。",
                linkText: "欧盟官方计算器",
                usedPrior: "已用 (前180天)", safeStay: "可停留", sinceLast: "距上次", untilNext: "距下次",
                expireMsg: "天过期"
            }
        };
                                ...
                                <>
                                    <section>
                                        ...
                                        <ul className="space-y-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg border">
                                            <li className="flex gap-2">👆 <strong>{t.h_tapEmpty}:</strong> {t.h_tapEmptyDesc}</li>
                                            <li className="flex gap-2">🗑️ <strong>{t.h_tapTrip}:</strong> {t.h_tapTripDesc}</li>
                                            <li className="flex gap-2">↔️ <strong>{t.h_dragBody}:</strong> {t.h_dragBodyDesc}</li>
                                            <li className="flex gap-2">➡️ <strong>{t.h_dragEdge}:</strong> {t.h_dragEdgeDesc}</li>
                                            <li className="flex gap-2">🔍 <strong>{t.h_dragTime}:</strong> {t.h_dragTimeDesc}</li>
                                        </ul>
                                    </section>
                                    <section>
        ...
        function App() {
            ...
            const TRIP_H = 120; // ~60% Height relative to 220ish
            ...
            const tripStats = useMemo(() => {
                ...
                sorted.forEach((t, index) => {
                    // 1. Check for Violations inside the trip
                    let firstOver = null;
                    let maxUsed = 0;
                    for(let d = t.start; d <= t.end; d += MS_PER_DAY) {
                        const u = calcUsage(d, sorted);
                        if(u > 90) {
                            if(!firstOver) firstOver = d;
                            maxUsed = Math.max(maxUsed, u - 90);
                        }
                    }
                    ...
                    if (firstOver) {
                        ...
                        // 2. Check Safe Extension
                        const nextTrip = sorted[index + 1];
                        const gap = nextTrip ? diffDays(nextTrip.start, t.end) - 1 : 180;
                        
                        let extendable = 0;
                        const maxSim = Math.min(gap, 90);

                        if (maxSim > 0) {
                            for(let i=1; i<=maxSim; i++) {
                                const extendedEnd = t.end + (i * MS_PER_DAY);
                                const tempTrips = sorted.map(tr => tr.id === t.id ? {...tr, end: extendedEnd} : tr);
                                
                                if(calcUsage(extendedEnd, tempTrips) > 90) break;

                                const checkHorizon = extendedEnd + (180 * MS_PER_DAY);
                                let futureBroken = false;
                                for(let j = index + 1; j < sorted.length; j++) {
                                    const ft = sorted[j];
                                    if(ft.start > checkHorizon) break;
                                    for(let fd = ft.start; fd <= ft.end; fd += MS_PER_DAY) {
                                        if(calcUsage(fd, tempTrips) > 90) {
                                            futureBroken = true;
                                            break;
                                        }
                                    }
                                    if(futureBroken) break;
                                }
                                if(futureBroken) break;
                                extendable = i;
                            }
                        ...
                        <div className="absolute inset-0 touch-none" ref={svgRef} onPointerDown={(e)=>onPointerDown(e, 'BG')}>
                            <svg width="100%" height="100%">
                                ...
                                {trips.map(t => {
                                    ...
                                    const stats = tripStats[t.id] || {};
                                    const isDanger = stats.type === 'danger';
                                    const isCompact = w < 65;
                                    ...
                                    return (
                                        <g key={t.id} transform={`translate(${x}, ${TRIP_Y})`}>
                                            {/* BODY */}
                                            <rect width={w} height={TRIP_H} rx="6" fill={fillColor} stroke={strokeColor} strokeWidth="2" onPointerDown={(e)=>onPointerDown(e,'TRIP',t.id)} className="shadow-lg"/>
                                            
                                            {/* HANDLE DECORATION */}
                                            <g transform={`translate(4, ${TRIP_H/2 - 8})`} opacity="0.5" className="pointer-events-none"><line x1="0" y1="0" x2="0" y2="16" stroke="white" strokeWidth="2"/><line x1="3" y1="0" x2="3" y2="16" stroke="white" strokeWidth="2"/></g>
                                            
                                            {/* RESIZE HANDLE */}
                                            <g transform={`translate(${w-20}, 0)`} onPointerDown={(e)=>onPointerDown(e,'RESIZE',t.id)}>
                                                <rect width="20" height={TRIP_H} rx="4" fill="rgba(0,0,0,0.1)" />
                                                <path d={`M8 ${TRIP_H/2 - 4}l4 4l-4 4`} stroke="white" strokeWidth="2" fill="none" opacity="0.8"/>
                                            </g>
                                            
                                            {/* TEXT CONTENT */}
                                            {isCompact ? (
                                                 <text x={w/2} y={TRIP_H/2} textAnchor="middle" dominantBaseline="middle" className="text-sm font-bold fill-white">
                                                     {diffDays(t.end, t.start)+1}d
                                                 </text>
                                            ) : (
                                                <g className="pointer-events-none">
                                                    {/* START DATE (Left) */}
                                                    <text x="10" y="24" textAnchor="start" className="text-xs font-bold fill-white opacity-90">
                                                        {formatShortDate(t.start, t.code)}
                                                    </text>

                                                    {/* END DATE (Right) */}
                                                    <text x={w-24} y="24" textAnchor="end" className="text-xs font-bold fill-white opacity-90">
                                                        {formatShortDate(t.end, t.code)}
                                                    </text>
                                                    
                                                    {/* DURATION (Center) */}
                                                    <text x={w/2} y={TRIP_H/2 + 5} textAnchor="middle" className="text-2xl font-bold fill-white">
                                                        {diffDays(t.end, t.start)+1} days
                                                    </text>

                                                    {/* STATUS (Right Aligned) */}
                                                    {isDanger ? (
                                                        <text x={w-24} y={TRIP_H - 12} textAnchor="end" className="text-xs font-bold fill-white">
                                                            OVERSTAY: +{stats.excess}d
                                                        </text>
                                                    ) : (
                                                        <text x={w-24} y={TRIP_H - 12} textAnchor="end" className="text-xs font-bold fill-white opacity-90">
                                                            Extendable: {stats.extendable >= 90 ? '> 90' : `+ ${stats.extendable}`}d
                                                        </text>
                                                    )}
                                                </g>
                                            )}
